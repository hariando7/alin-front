...
export default function iconRightSidebar() {
    return (
        <>
            {/* <!-- Right Sidebar --> */}
                ...
                <div class="drawer-content fixed right-0 top-0 z-[151] hidden h-full w-full sm:w-80">
                    <div class="right-sidebar-tab-wrapper w-ful relative flex h-full flex-col bg-white dark:bg-navy-750">
                        <div class="flex items-center justify-between py-2 px-4">
                            <p data-header="#right-sidebar-tab-home"
                            ...
                            <p data-header="#right-sidebar-tab-project"
                                class="right-sidebar-header flex shrink-0 items-center space-x-1.5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                            ...
                            <p data-header="#right-sidebar-tab-activity"
                                class="right-sidebar-header flex shrink-0 items-center space-x-1.5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor" stroke-width="1.5">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="mt-3 space-y-3 px-2">
                                    <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                                        ...
                                        <img src="images/800x600.png" class="h-20 w-20 rounded-lg object-cover object-center" alt="image" />
                                    </div>
                        ...
                        <div id="right-sidebar-tab-project"
                        ...
                        <div id="right-sidebar-tab-activity"
                            class="tab-content tab-shift-up is-scrollbar-hidden overflow-y-auto overscroll-contain pt-1">
                        ...
                        <div class="pointer-events-none absolute bottom-4 flex w-full justify-center">
                            <div
                                ...
                                <button data-target="#right-sidebar-tab-home"
                                ...
                                <button data-target="#right-sidebar-tab-project"
                                    data-active-class="text-primary dark:text-accent [&_svg:last-child]:hidden"
                                    data-default-class="[&_svg:first-child]:hidden"
                                    class="tab btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" viewBox="0 0 20 20"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="h-5 w-5 shrink-0" viewBox="0 0 24 24"
                                        stroke="currentColor" stroke-width="1.5">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
                                    </svg>
                                </button>
                                <button data-target="#right-sidebar-tab-activity"
                                    data-active-class="text-primary dark:text-accent [&_svg:last-child]:hidden"
                                    data-default-class="[&_svg:first-child]:hidden"
                                    class="tab btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" viewBox="0 0 20 20"
